...
[Prototype & Design](/design/), tilted at 0.0663 rad (3.80°), with a textured surface to
...
discussed qualitatively (see [Lessons Learned](/lessons/)) rather than quantified
directly in the results, and it's the direct motivation for planned sensor-based data
acquisition in future work.

Continue to [Results](/results/) for what came out of this setup.
